    ...
    <div className="md:px-10 px-7 my-10" id="contact">
      <div className="flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2">
          <h1 className="text-pink-600 font-semibold text-3xl mt-16">
            Connect with me:
          </h1>
          ...
          <div className="flex space-x-4">
            ...
            >
              <img src={facebook} alt="Facebook" className="w-8 h-8 filter invert" />
            </a>
            <a
              ...
              className="transition-all duration-300 hover:text-pink-600"
            >
              <img src={instagram} alt="Instagram" className="w-8 h-8 filter invert" />
            </a>
            <a
              ...
              className="transition-all duration-300 hover:text-pink-600"
            >
              <img src={dribbble} alt="Dribbble" className="w-8 h-8 filter invert" />
            </a>
            <a
              href="mailto:anpch@example.com"
              target="_blank"
              ...
              className="transition-all duration-300 hover:text-pink-600"
            >
              <img src={email} alt="Email" className="w-8 h-8 filter invert" />
            </a>
          </div>
        </div>
        ...
        <div className="md:w-1/2">
          ...
          <form>
            ...
            ></textarea>
            <button
              className="btn transition-all duration-500 bg-pink-600 py-2 px-12 rounded text-white hover:bg-white hover:text-pink-600 block"
            >
              Send
            </button>
          </form>
